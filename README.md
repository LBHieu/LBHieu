...
![Django](https://img.shields.io/badge/Django-3.2-darkgreen?style=flat&logo=django)
...
- 👁️ **Suricata**: An open-source threat detection engine that performs intrusion detection, inline intrusion prevention, and network security monitoring.
